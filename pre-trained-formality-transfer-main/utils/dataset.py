...
def read_data(dataset, style, max_len, prefix,
    ...
    if style == 0:
        src_file = '/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/GYAFC_Corpus/Entertainment_Music/train/informal'.format(dataset, prefix)
        tgt_file = '/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/GYAFC_Corpus/Entertainment_Music/train/formal'.format(dataset, prefix)
    else:
        src_file = '/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/GYAFC_Corpus/Family_Relationships/train/informal'.format(dataset, prefix)
        tgt_file = '/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/GYAFC_Corpus/Family_Relationships/train/formal'.format(dataset, prefix)
