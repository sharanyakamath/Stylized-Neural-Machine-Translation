...
def main():
    ...
    parser.add_argument('-steps', default=300, type=int, help='force stop at x steps')
    ...
    parser.add_argument('-eval_step', default=300, type=int, help='evaluate every x step')
