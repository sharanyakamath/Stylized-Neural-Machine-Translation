...
def main():
    ...
    src_seq = []
    with open('/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/GYAFC_Corpus/Family_Relationships/test/informal'.format(opt.dataset, opt.style)) as fin:
        for line in fin.readlines():
            src_seq.append(line.strip())

    start = time.time()
    with open('/content/drive/MyDrive/SEM2/685/Project/pre-trained-formality-transfer-main/outputs/new_{}_{}_{}.{}.txt'.format(
